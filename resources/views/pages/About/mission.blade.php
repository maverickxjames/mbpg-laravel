...
<body class="path-node node--type-page">
    ...
    <h1>Vision</h1>
    <p>
        Maa Bharti PG College aspires to lead the way in multidisciplinary education, gaining national and international acclaim for its commitment to academic excellence, holistic development, and active societal engagement.
    </p>

    <h1>Mission</h1>
    <p>
        We aim to empower our students through pioneering and interdisciplinary programs, encouraging critical thinking, fostering creativity, and nurturing ethical leadership.
    </p>
    <p>
        Our goal is to create a vibrant learning environment that celebrates inclusivity, diversity, and gender equality, guiding individuals to become global citizens and responsible members of society.
    </p>
    <p>
        We are dedicated to providing outstanding education and research opportunities in the fields of science, arts, and technology, with a focus on hands-on learning, collaboration with industry, and sustainable practices.
    </p>
    <p>
        We are committed to making a difference through impactful community outreach initiatives, addressing pressing societal issues, promoting mental health awareness, and fostering a culture of empathy, compassion, and social responsibility.
    </p>
    <p>
        We strive for continuous improvement, embracing emerging technologies, best practices, and innovative teaching methods to adapt to the changing needs of our students and society.
    </p>
    <p>
        We endeavor to build strong partnerships with industry, academia, and government bodies to enhance the employability, entrepreneurship, and research prospects for both our students and faculty.
    </p>
</div>
