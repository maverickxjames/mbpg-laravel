                                    ...
                                    <div class="col-sm-7 col-md-8">
                                        <div class="main-region">
                                            <div data-block-plugin-id="lbk_rich_text">
                                                ...
                                                <div id="pg" class="content block-content" style="padding-top: 60px;">
                                                    <div class="lbk-rich-text-component container">
                                                      <h1>PG</h1>
                                                                <table class=" content-table "
                                                                  >
                                               ...
                                               <div id="phd" class="content block-content" style="padding-top: 60px;">
                                                    <div class="lbk-rich-text-component container">
                                                      <h1>PHD</h1>
                                                                <table class=" content-table "
                                                                  >
