                                            ...
                                            <div data-block-plugin-id="lbk_rich_text">
                                                ...
                                                <div class="content block-content">
                                                    ...
                                                    <div class="lbk-rich-text-component container">
                                                        <div class="content block-content">
                                                            <p>
                                                              The college operates a functional Students' Grievance Redressal Committee, entrusted with the responsibility of addressing student concerns promptly and effectively. The primary role of this committee is to investigate and resolve complaints lodged by any student in a timely manner. Additionally, the Grievance Redressal Committee holds the authority to address issues related to harassment, ragging, and any other pertinent matters. Individuals with legitimate grievances are encouraged to approach committee members directly. Alternatively, grievances can be submitted in writing or via email to the designated officer overseeing the Students' Grievance Redressal Committee or to the Principal.
                                                            </p>
                                                            <img src="https://mobflix.s3.ap-south-1.amazonaws.com/mb/GRIEVANCE.jpg"
                                                                alt="alumni">

                                                            <h1 style="margin-top: 50px">The Committee Members are</h1>
                                                           <ul>
    <li>Dr. Rakesh Rajora</li>
    <li>Mrs. Nidhi Bhargava</li>
    <li>Mr. C.M. Nagar</li>
    <li>Mr. Yatish Arya</li>
    <li>Mr. Pradeep Verma</li>
</ul>
