                                    ...
                                    <div class="col-sm-7 col-md-8">
                                        <div class="main-region">
                                            ...
                                            <div data-block-plugin-id="lbk_rich_text">
                                                <p
                                                    style="font-weight: bold;margin-top: 20px;font-size:40px;text-align: center;text-transform: uppercase;text-decoration: underline;margin-bottom: 40px;line-height: 1.5;">
                                                    ANTI-RAGGING CELL & Discipline Committee
                                                ...
                                                <div class="content block-content">
                                                    ...
                                                    <div class="lbk-rich-text-component container">
                                                        <div class="content block-content">
                                                            ...
                                                            <p>Ragging is strictly prohibited in the college premises
                                                                and outside students indulging in ragging will be
                                                                punished as per the UGC's “Curbing the menace of Ragging
                                                                in Higher Educational Institutions (third amendment),
                                                                Regulations, 2016.</p>
                                                            <img src="https://mobflix.s3.ap-south-1.amazonaws.com/mb/disciplinelogo.jpg"
                                                                alt="alumni">

                                                            <h1 style="margin-top: 50px">Act/ Behaviour that can be
                                                                treated as Ragging/Indiscipline</h1>
                                                            <ul>
                                                                <li>Mental / Physical / Sexual Abuse</li>
                                                                <li>Verbal Abuse</li>
                                                                <li>Indecent Behaviour</li>
                                                                <li>Criminal Behaviour</li>
                                                                <li>Intimidation / Wrongful Restraint</li>
                                                                <li>Undermining Human Dignity</li>
                                                                <li>Face Action</li>
                                                                <li>Financial Exploitation / Extortion Action</li>
                                                                <li>Use of Force</li>
                                                            </ul>

                                                            <h1 style="margin-top: 50px">Action that can be taken
                                                                against those who are engaged in Ragging/ Indiscipline
                                                            </h1>

                                                            <ul>
                                                                <li>Expelled From the Institution</li>
                                                                <li>Scholarship Can Be Withdrawn</li>
                                                                <li>Denied Admission to Any Institute</li>
                                                                <li>Prosecuted for Action</li>
                                                                <li>The Institution Can File FIR With the Local Police
                                                                    Station Against Those Who Are Engaged in Ragging
                                                                </li>
                                                            </ul>


                                                            <p
                                                                style="font-weight: bold;margin-top: 20px;font-size:24px;text-align: center;margin-bottom: 40px;line-height: 1.5;">
                                                                You can also email your complaint on <a
                                                                    href="mailto:mbpgcollege@yahoo.com">mbpgcollege@yahoo.com</a>

                                                            </p>

                                                            <h1>Anti-Ragging Cell and Discipline Committee Members are
                                                            </h1>

                                                            <ul>
                                                                <li>Dr. Shweta Saxena (Convenor)</li>
                                                                <li>Mr. Ranjeet Singh (Media Representative)</li>
                                                                <li>Mr. Sunil Gautam (Civil Representative)</li>
                                                                <li>Mr. Ashok Chaudhary (Police Representative)</li>
                                                                <li>Dr. Sushma Agrwal (Member)</li>
                                                                <li>Dr. Arshi Abbasi (Member)</li>
                                                                <li>Dr. Sarita Gautam (Member)</li>
                                                                <li>Dr. Amit Jain (Member)</li>
                                                                <li>Mr. Navneet Soni (Member)</li>
                                                                <li>Mr. Vivek Kaushik (Guardian of Regular Student - UG)
                                                                </li>
                                                                <li>Mr. Bal Mukund Acharya (Guardian of Regular Student
                                                                    - UG)</li>
                                                            </ul>
                                            ...
                                            <div
                                                ...
                                                <div class="content block-content">
                                                    ...
                                                    <div class="banner__strip"
                                                        style="background-image: url('https://mobflix.s3.ap-south-1.amazonaws.com/mb/anti_ragging_banner.png');background-size: cover;height: 400px;">
                                                        <div class="container">
