                                                    ...
                                                    <div class="lbk-rich-text-component container">
                                                        <div class="content block-content">
                                                            <p>
                                                                ...
                                                                (SVEEP) Programme are undertaken to educate the students
                                                                regarding procedure relating to registration of name in
                                                                Electoral Roll, correct of their existing particulars in
                                                                Electoral Roll and deletion of name of shifted and
                                                                deceased family members.


                                                            </p>

                                                            <p>SVEEP activities are also meant to inform about various
                                                                online, offline facilities available to voters regarding
                                                                ethical voting like how to cast vote, how to help the
                                                                election machinery to prevent corrupt practices during
                                                                election etc.

                                                            </p>
                                                            <img src="https://mobflix.s3.ap-south-1.amazonaws.com/mb/sveep.jpg"
                                                                alt="alumni">

                                                            <h1>For awareness of general voters, following activities
                                                                are conducted in the college</h1>

                                                            <ul>
                                                                <li>Running Outdoor Media Campaign by way of displaying
                                                                    voter awareness messages</li>
                                                                <li>Display of Voter’s Awareness Banners</li>
                                                                <li>Organizing Nukkad Natak, Plays, Discussion, Debate,
                                                                    etc. to make students aware about the electoral
                                                                    process and their voting rights</li>
                                                                <li>Voter’s Awareness Campaign by poster, slogan,
                                                                    rangoli, etc.</li>
                                                            </ul>


                                                            <h1>SVEEP Cell/Electoral Literacy Club Members are</h1>

                                                            <ul>
                                                                <li>Mr. Yatish Arya</li>
                                                                <li>Dr. Achal Arvind</li>
                                                                <li>Dr. Neeru Chaudhary</li>
                                                                <li>Dr. Rakesh Rajora</li>
                                                                <li>Dr. Aarti Sharma</li>
                                                                <li>Mr. Hemant Meghwal</li>
                                                            </ul>
                                            ...
                                            <div
                                                ...
                                                <div class="content block-content">
                                                    ...
                                                    <div class="banner__strip"
                                                        style="
        background-image: url('https://mobflix.s3.ap-south-1.amazonaws.com/mb/voteindia.jpg'),
                          url('https://mobflix.s3.ap-south-1.amazonaws.com/mb/voting.jpg');
