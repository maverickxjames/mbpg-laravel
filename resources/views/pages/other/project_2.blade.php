                                        ...
                                        <div class="main-region">
                                            <div data-block-plugin-id="lbk_rich_text">
                                                <div id="ug" class="content block-content">
                                                    ...
                                                    <h1>2.3.1 Student centric methods, such as experiential learning, participative learning and problem-solving methodologies are used for enhancing learning experiences and teachers use ICT- enabled tools including online resources for effective teaching and learning process
</h1>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr
                                                                            ...
                                                                            <li style="border-bottom: 1px solid rgba(151, 151, 151, 0.35)" class="bottom-border"
                                                                                ...
                                                                                <a href="{{ asset('/pdf/project-2/' . $item->slug) }}"
                                                                                    target="_blank"
                                                                                    title="{{ $item->name }}">
                                                                                   View PDF
                                                                                </a>
