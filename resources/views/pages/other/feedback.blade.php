                                            ...
                                            <div data-block-plugin-id="lbk_rich_text">
                                                <div class="content block-content">
                                                    ...
                                                    <div class="lbk-rich-text-component container">
                                                        ...
                                                        <h1>1.4.1. FEEDBACK SYSTEM LINK OF THE DOCUMENT TO SUPPORT THE CLAIM THAT FEEDBACK IS COLLECTED FROM STUDENTS, FACULTY AND ALUMNI</h1>
                                                        ...
                                                        <table class=" content-table " style="text-align: center">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th style="text-align: center">Feedback System
                                                                    </th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                @foreach ($feedback as $group => $items)
                                                                    <tr>
                                                                        <td>{{ $items[0]->code }}</td>
                                                                        <td>
                                                                            <ul class="document__list"
                                                                                style="padding-bottom: 0px; list-style:none;">
                                                                                @foreach ($items as $item)
                                                                                    <li
                                                                                        style="border-bottom: 1px solid rgba(151,151,151,0.35)">
                                                                                        <a href="/pdf/feedback/{{ $item->slug }}"
                                                                                            target="_blank">
                                                                                            {{ $item->name }}
                                                                                        </a>
                                                                                    </li>
