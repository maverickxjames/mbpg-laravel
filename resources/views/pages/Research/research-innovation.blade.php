                                    ...
                                    <div class="col-sm-7 col-md-12">
                                        <div class="main-region">
                                            ...
                                            <div data-block-plugin-id="lbk_rich_text">
                                                <p
                                                    style="font-weight: bold;margin-top: 20px;font-size:40px;text-align: center;text-transform: uppercase;text-decoration: underline;margin-bottom: 50px;line-height:50px">
                                                    ...
                                                    <div class="lbk-rich-text-component container">
                                                        <div class="content block-content">
                                                            ...
                                                            <div class="pdf-desktop-view">
                                                                <iframe
                                                                    src="https://mobflix.s3.ap-south-1.amazonaws.com/mb/ResearchCell.pdf"
                                                ...
                                                <div class="content block-content" style="margin-top: 50px;margin-bottom: 50px;">

                                                    <div class="lbk-rich-text-component container">
                                                        <div class="content block-content">
                                                            <h1>Intellectual Property Rights Cell</h1>
                                                            <!-- PDF iFrame visible on large screens -->
                                                            <div class="pdf-desktop-view">
                                                                <iframe
                                                                    src="https://mobflix.s3.ap-south-1.amazonaws.com/mb/iprcell.pdf"
                                                                    width="100%" height="800px"
                                                                    style="border: none;">
                                                                </iframe>
                                                            </div>
                                                ...
                                                <div class="content block-content" style="margin-top: 50px">
                                                    ...
                                                    <div class="lbk-rich-text-component container">
                                                        <div class="content block-content">
                                                            <h1>Indian knowledge systems cell (IKS)</h1>
                                                            <!-- PDF iFrame visible on large screens -->
                                                            <div class="pdf-desktop-view">
                                                                <iframe
