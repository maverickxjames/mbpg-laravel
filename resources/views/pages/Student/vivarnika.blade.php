                                            ...
                                            <div data-block-plugin-id="lbk_rich_text">
                                                ...
                                                <div class="content block-content">
                                                    ...
                                                    <div class="lbk-rich-text-component container">
                                                        <div class="content block-content">
                                                            <h1>Vivarnika 2024-25</h1>
                                                            <!-- PDF iFrame visible on large screens -->
                                                            <div class="pdf-desktop-view">
                                                                <iframe
                                                                    src="https://mobflix.s3.ap-south-1.amazonaws.com/mb/Vivarnika2024-25.pdf"
                                                            ...
                                                            <div class="pdf-mobile-view">
                                                                ...
                                                                <ul class="document__list">
                                                                    <li><a href="https://mobflix.s3.ap-south-1.amazonaws.com/mb/Vivarnika2024-25.pdf"
                                                                            target="_blank"
                                                                            title="Vivarnika 2024-25">Vivarnika 2024-25</a></li>
                                                                    <li></li>
                                                                </ul>
                                                            </div>
