                                    ...
                                    <div class="col-sm-7 col-md-12">
                                        <div class="main-region">
                                            ...
                                            <div data-block-plugin-id="lbk_rich_text">
                                                <p
                                                    style="font-weight: bold;margin-top: 20px;font-size:40px;text-align: center;text-transform: uppercase;text-decoration: underline;margin-bottom: 40px;">
                                                    NSS
                                                ...
                                                <div class="content block-content">
                                                    ...
                                                    <div class="lbk-rich-text-component container">
                                                        <div class="content block-content">
                                                            <p>
                                                                The <strong>National Service Scheme (NSS)</strong> is an
                                                                Indian
                                                                government sector public service program conducted by
                                                                the Ministry of Youth Affairs and Sports of the
                                                                Government of India. Popularly known as NSS, the scheme
                                                                was launched in Mahatma Ghandi 's centenary year in
                                                                1969.
                                                            </p>
                                                            <p><strong>National Service Scheme</strong>,popularly known
                                                                as NSS is an
                                                                ...
                                                                aegis of Minister of Youth affairs & sports, govt. of
                                                                India. It provide opportunity to the student youth to
                                                                take part in various government led community service
                                                                activities & programmes.</p>
                                                            <p>Maa Bharti PG College has a unit of NSS, it has 100
                                                                students. We follow NSS calendar and get all the
                                                                activities done.</p>


                                                            <h1>ORIENTATION PROGRAM FOR NSS VOLUNTEERS</h1>
                                                            <div class="pdf-desktop-view">
                                                                <iframe
                                                                    src="https://mobflix.s3.ap-south-1.amazonaws.com/mb/mbpg_nss.pdf"
                                                            ...
                                                            <div class="pdf-mobile-view">
                                                                 ...
                                                                 <ul class="document__list">
                                                                    <li><a href="https://mobflix.s3.ap-south-1.amazonaws.com/mb/mbpg_nss.pdf"
                                                                            target="_blank"
                                                                            title="ORIENTATION PROGRAM FOR NSS VOLUNTEERS">ORIENTATION PROGRAM FOR NSS VOLUNTEERS</a></li>
                                                                    <li></li>
