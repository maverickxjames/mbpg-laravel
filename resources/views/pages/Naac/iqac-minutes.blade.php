                                            ...
                                            <div data-block-plugin-id="lbk_rich_text">
                                                ...
                                                <div class="content block-content">
                                                    ...
                                                    <div class="lbk-rich-text-component container">
                                                        <div class="content block-content">
                                                            <h1>IQAC MINUTES MEETING 2018-2019</h1>
                                                            <!-- PDF iFrame visible on large screens -->
                                                            <div class="pdf-desktop-view">
                                                                <iframe
                                                                    src="https://mobflix.s3.ap-south-1.amazonaws.com/mb/IQAC_2018-2019.pdf"
                                                ...
                                                <div class="content block-content" style="margin-top: 50px">
                                                    ...
                                                    <div class="lbk-rich-text-component container">
                                                        <div class="content block-content">
                                                            <h1>IQAC MINUTES MEETING 2019-2020</h1>
                                                            <!-- PDF iFrame visible on large screens -->
                                                            <div class="pdf-desktop-view">
                                                                <iframe
                                                                    src="https://mobflix.s3.ap-south-1.amazonaws.com/mb/IQAC_2019_2020.pdf"
                                                                    width="100%" height="800px"
                                                                    style="border: none;">
                                                                </iframe>
                                                            </div>
                                                ...
                                                <div class="content block-content" style="margin-top: 50px">
                                                    ...
                                                    <div class="lbk-rich-text-component container">
                                                        <div class="content block-content">
                                                            <h1>IQAC MINUTES MEETING 2020-2021</h1>
                                                            <!-- PDF iFrame visible on large screens -->
                                                            <div class="pdf-desktop-view">
                                                                <iframe
                                                                    src="https://mobflix.s3.ap-south-1.amazonaws.com/mb/IQAC_2020_2021.pdf"
                                                                    width="100%" height="800px"
                                                                    style="border: none;">
                                                                </iframe>
                                                            </div>
                                                ...
                                                <div class="content block-content" style="margin-top: 50px">
                                                    ...
                                                    <div class="lbk-rich-text-component container">
                                                        <div class="content block-content">
                                                            <h1>IQAC MINUTES MEETING 2021-2022</h1>
                                                            <!-- PDF iFrame visible on large screens -->
                                                            <div class="pdf-desktop-view">
                                                                <iframe
                                                                    src="https://mobflix.s3.ap-south-1.amazonaws.com/mb/IQAC_2021_2022.pdf"
                                                                    width="100%" height="800px"
                                                                    style="border: none;">
                                                                </iframe>
                                                            </div>
                                                ...
                                                <div class="content block-content" style="margin-top: 50px">
                                                    ...
                                                    <div class="lbk-rich-text-component container">
                                                        <div class="content block-content">
                                                            <h1>IQAC MINUTES MEETING 2022-2023</h1>
                                                            <!-- PDF iFrame visible on large screens -->
                                                            <div class="pdf-desktop-view">
                                                                <iframe
                                                                    src="https://mobflix.s3.ap-south-1.amazonaws.com/mb/IQAC_2022_2023.pdf"
                                                                    width="100%" height="800px"
                                                                    style="border: none;">
                                                                </iframe>
                                                            </div>
