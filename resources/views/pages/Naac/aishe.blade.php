                                            ...
                                            <div data-block-plugin-id="lbk_rich_text">
                                                ...
                                                <div class="content block-content">
                                                    ...
                                                    <div class="lbk-rich-text-component container">
                                                        <div class="content block-content">
                                                            <h1>All India Survey on Higher Education (AISHE)</h1>
                                                            <!-- PDF iFrame visible on large screens -->
                                                            <div class="pdf-desktop-view">
                                                                <iframe
                                                                    src="https://mobflix.s3.ap-south-1.amazonaws.com/mb/aishe.pdf"
                                                            ...
                                                            <div class="pdf-mobile-view">
                                                                  ...
                                                                  <ul class="document__list">
                                                                    <li><a href="https://mobflix.s3.ap-south-1.amazonaws.com/mb/aishe.pdf"
                                                                            target="_blank"
                                                                            title="All India Survey on Higher Education (AISHE)">All India Survey on Higher Education (AISHE)</a></li>
                                                                    <li></li>
