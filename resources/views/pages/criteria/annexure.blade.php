 ...
 --}}
                                                        ...
                                                        <table class=" content-table " style="text-align: center">
                                                            <thead>
                                                                <tr>
                                                                    <th style="text-align: center">S.NO.</th>
                                                                    <th style="text-align: center">CLARIFICATION
                                                                    </th>
                                                                    <th>Link</th>
                                                                </tr>
                                                            </thead>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <ul class="document__list"
                                                                                ...
                                                                                <li style="border-bottom: 1px solid rgba(151, 151, 151, 0.35)"><a href="{{'/pdf/annexure/'.$annexure->slug }}" target="_blank"
