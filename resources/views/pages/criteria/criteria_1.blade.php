                                                    ...
                                                    <div class="lbk-rich-text-component container">
                                                        ...
                                                        <table class="content-table" style="text-align:center">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                {{-- Criterion header --}}
                                                                <tr style="background-color:#e4e2f7;font-weight:bold">
                                                                    <td>{{ $criteria->criteria_no }} </td>
                                                                ...
                                                                @foreach($indicator->link_groups as $group)
                                                                <tr>
                                                                    {{-- Indicator code & title only on first row for
                                                                    this indicator --}}
                                                                    @if($firstIndicatorRow)
                                                                    <td rowspan="{{ $indicator->rowspan }}">
                                                                        {{ $indicator->indicator_code }}
                                                                    </td>
                                                                    {{-- <td rowspan="{{ $indicator->rowspan }}">

                                                                    </td> --}}
                                                                    @php $firstIndicatorRow = false; @endphp
                                                                    @endif

                                                                    {{-- Links for this group --}}
                                                                    <td>
                                                                        {{-- <p style="margin:0 0 10px;font-weight:600">
                                                                            {{ $indicator->indicator_title }}</p> --}}
                                                                        ...
                                                                        <p
                                                                            style="border-top:1px solid rgba(151, 151, 151, 0.35);border-bottom:1px solid rgba(151, 151, 151, 0.35);padding:10px;margin:0">
                                                                            <a class="readmore"
                                                                                href="{{ $link->link_url }}"
                                                                                target="_blank"
                                                        ...
                                                        <table class=" content-table " style="text-align: center">
                                                            ...
                                                            <tbody>
                                                                <tr style="background-color: #e4e2f7;font-weight:bold">
                                                                    <td>1.1</td>
                                                                    <td>CURRICULAR PLANNING AND IMPLEMENTATION</td>

                                                                </tr>
                                                                <tr>
                                                                    <td>1.1.1</td>
                                                                    <td>
                                                                        <p style="margin:0 0 10px;font-weight:600">CLASS
                                                                            WISE TIMETABLE</p>

                                                                        <ul class="document__list"
                                                                            style="padding-bottom: 0px">
                                                                            <li><a href="#" target="_blank"
                                                                                    title="SESSION 2022-2023">SESSION
                                                                                    2022-2023</a></li>
                                                                            <li class="bottom-border"><a href="#"
                                                                                    target="_blank"
                                                                                    title="SESSION 2022-2023">SESSION
                                                                                    2023-2024</a></li>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <ul class="document__list"
                                                                            ...
                                                                            <li class="bottom-border"><a href="#"
                                                                                    target="_blank"
                                                                                    title="ACADEMIC CALENDAR OF RAJASTHAN 2022-2023">ACADEMIC
                                                                                    CALENDAR OF RAJASTHAN 2022-2023</a>
                                                                            </li>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <p
                                                                            style="border-top:1px solid rgba(151, 151, 151, 0.35);border-bottom:1px solid rgba(151, 151, 151, 0.35);padding:10px;margin:0">
                                                                            <a class="readmore"
                                                                                href="https://www.univexam.info/"
                                                                                target="_blank"
                                                                                title="DEPARTMENTAL TEACHING PLAN">DEPARTMENTAL
                                                                                TEACHING PLAN</a>
                                                                        </p>
                                                                        {{-- <p
                                                                            style="border-top:1px solid rgba(151, 151, 151, 0.35);border-bottom:1px solid rgba(151, 151, 151, 0.35);padding:10px;margin:0">
                                                                        ...
                                                                        <ul class="document__list"
                                                                            ...
                                                                            <li class="bottom-border"><a href="#"
                                                                                    target="_blank"
                                                                                    title="ACADEMIC CALENDAR">ACADEMIC
                                                                                    CALENDAR</a></li>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <ul class="document__list"
                                                                            ...
                                                                            <li class="bottom-border"><a href="#"
                                                                                    target="_blank"
                                                                                    title="PROVISION FOR CIA, UNIVERSITY OF KOTA">PROVISION
                                                                                    FOR CIA, UNIVERSITY OF KOTA</a></li>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <ul class="document__list"
                                                                            ...
                                                                            <li class="bottom-border"><a href="#"
                                                                                    target="_blank"
                                                                                    title="MECHANISM OF CIA IN THE INSTITUTION">MECHANISM
                                                                                    OF CIA IN THE INSTITUTION</a></li>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <p
                                                                            style="border-top:1px solid rgba(151, 151, 151, 0.35);border-bottom:1px solid rgba(151, 151, 151, 0.35);padding:10px;margin:0">
                                                                            <a class="readmore" href="#" target="_blank"
                                                                                title="ADD-ON COURSES">ADD-ON
                                                                                COURSES</a>
                                                                        </p>
                                                                    </td>
                                                                </tr>
