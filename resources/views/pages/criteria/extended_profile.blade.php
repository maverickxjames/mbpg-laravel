                                                ...
                                                <div class="content block-content">
                                                    ...
                                                    <div class="lbk-rich-text-component container">
                                                        ...
                                                        <table class=" content-table " style="text-align: center">
                                                            ...
                                                            <tbody>   
                                                               @foreach ($extended_profile as $data)
                                                                 <tr>
                                                                    <td>{{ $data->id.'.1' }}</td>
                                                                    <td>
                                                                        <ul class="document__list"
                                                                            style="padding-bottom: 0px">
                                                                            <li style="border-bottom: 1px solid rgba(151, 151, 151, 0.35)"><a href="/pdf/extended-profile/{{ $data->slug }}" target="_blank"
                                                                                    title="Number of students year wise during the last five years">{{ $data->name }}</a></li>
                                                                        </ul>
                                                                    </td>
