                                    ...
                                    <div class="col-sm-7 col-md-12">
                                        <div class="main-region">
                                            ...
                                            <div data-block-plugin-id="lbk_rich_text">
                                                <p
                                                    style="font-weight: bold;line-height:50px;margin-top: 20px;font-size:40px;text-align: center;text-transform: uppercase;text-decoration: underline;margin-bottom: 50px;">
                                                ...
                                                <div class="content block-content">
                                                    ...
                                                    <div class="lbk-rich-text-component container">
                                                        <div class="content block-content">
                                                            <h1>Academic Calendar Department of College Education, Rajasthan, 2022-23</h1>
                                                            <!-- PDF iFrame visible on large screens -->
                                                            <div class="pdf-desktop-view">
                                                                <iframe
                                                                    src="https://mobflix.s3.ap-south-1.amazonaws.com/mb/Academic-calendar-2022-23.pdf"
                                                ...
                                                <div class="content block-content" style="margin-top: 50px">
                                                    ...
                                                    <div class="lbk-rich-text-component container">
                                                        <div class="content block-content">
                                                            <h1>Academic Calendar 2022-23</h1>
                                                            <!-- PDF iFrame visible on large screens -->
                                                            <div class="pdf-desktop-view">
                                                                <iframe
                                                                    src="https://mobflix.s3.ap-south-1.amazonaws.com/mb/CALENDERALL_.pdf"
                                                                    width="100%" height="800px"
                                                                    style="border: none;">
                                                                </iframe>
                                                            </div>
                                                ...
                                                <div class="content block-content" style="margin-top: 50px">
                                                    ...
                                                    <div class="lbk-rich-text-component container">
                                                        <div class="content block-content">
                                                            <h1>Class Wise timetable - session 2022-23</h1>
                                                            <!-- PDF iFrame visible on large screens -->
                                                            <div class="pdf-desktop-view">
                                                                <iframe
                                                                    src="https://mobflix.s3.ap-south-1.amazonaws.com/mb/time.table.22.23.pdf"
                                                                    width="100%" height="800px"
                                                                    style="border: none;">
                                                                </iframe>
                                                            </div>
                                                ...
                                                <div class="content block-content" style="margin-top: 50px">
                                                    ...
                                                    <div class="lbk-rich-text-component container">
                                                        <div class="content block-content">
                                                            <h1>Class Wise timetable - session 2023-24</h1>
                                                            <!-- PDF iFrame visible on large screens -->
                                                            <div class="pdf-desktop-view">
                                                                <iframe
                                                                    src="https://mobflix.s3.ap-south-1.amazonaws.com/mb/time.table.23.24.pdf"
                                                                    width="100%" height="800px"
                                                                    style="border: none;">
                                                                </iframe>
                                                            </div>
